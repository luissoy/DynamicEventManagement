package com.dynamiceventmanagement.notificationapp.controller;

import com.dynamiceventmanagement.notificationapp.exception.DatabaseApiException;
import com.dynamiceventmanagement.notificationapp.service.EventService;
...
public class EventController {
    ...
    public ResponseEntity<?> save(
        ...
        return ResponseEntity.status(HttpStatus.CREATED).
                body(eventService.save(userId, groupId, message));
    }
}
